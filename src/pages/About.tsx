    ...
    <Flex height={"75vh"} minWidth={"100vw"} background={"red"} align="center" justify="center">
      <Container maxW="container.lg">
        <Flex direction={{ base: "column", lg: "row" }} alignItems={{ lg: "center" }}>
          ...
          >
            <Box>
              <Heading size="md" mb={2}>Quienes somos</Heading>
              <Heading size="lg" mb={4}>Expedita voluptas omnis cupiditate totam eveniet nobis sint iste. Dolores est repellat corrupti reprehenderit.</Heading>
              <Text mb={4}>
